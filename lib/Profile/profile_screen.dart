                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                      "${getprofile?.user?.userData?.first.mobile}"),
                                )
                              ],
                            ),
                          ),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                            "${getprofile?.user?.userData?.first.experience}"),
                                      )
                                    ],
                                  ),
                                )
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: getprofile?.user?.userData?.first
                                            ...
                                            ? Text("No Name")
                                            : Text(
                                                "${getprofile?.user?.userData?.first.docDigree}"),
                                      )
                                    ],
                                  ),
                                )
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(left: 0.0),
                                  child: Text(
                                      "${getprofile?.user?.userData?.first.gender}"),
                                )
                              ],
                            ),
                          ),
                                      ...
                                      Container(
                                        ...
                                        child: Padding(
                                          padding:
                                              const EdgeInsets.only(left: 0.0),
                                          child: Text(
                                            "${getprofile?.user?.userData?.first.categoryId}",
                                            overflow: TextOverflow.ellipsis,
                                            maxLines: 1,
                                          ),
                                        ),
                          ...
                          roll == "2"
                              ? Container(
                                  ...
                                  child: ListView.builder(
                                      ...
                                      shrinkWrap: true,
                                      itemCount: getprofile?.user?.userData
                                          ?.first.clinics?.length,
                                      itemBuilder:
                                                    ...
                                                    Padding(
                                                      padding:
                                                          const EdgeInsets.all(
                                                              8.0),
                                                      child: Text(
                                                        "${getprofile?.user?.userData?.first.clinics?[index].clinicName}",
                                                        style: TextStyle(
                                                          color:
                                                              colors.blackTemp,
                                                        ),
                                                    ...
                                                    Padding(
                                                      padding:
                                                          const EdgeInsets.only(
                                                              left: 0.0),
                                                      child: Text(
                                                          "${getprofile?.user?.userData?.first.clinics?[index].morningShift}"),
                                                    )
                                                  ],
                                                ),
                                              ),
                                                    ...
                                                    Padding(
                                                      padding:
                                                          const EdgeInsets.only(
                                                              left: 0.0),
                                                      child: Text(
                                                          "${getprofile?.user?.userData?.first.clinics?[index].eveningShift}"),
                                                    )
                                                  ],
                                                ),
                                              ),
                                              Padding(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      "${getprofile?.user?.userData?.first.clinics?[index].addresses}",
                                                      overflow:
                                                    ...
                                                    Padding(
                                                      padding:
                                                          const EdgeInsets.only(
                                                              left: 0.0),
                                                      child: Text(
                                                          "${getprofile?.user?.userData?.first.clinics?[index].appointNumber}"),
                                                    )
                                                  ],
                                                ),
                                              ),
